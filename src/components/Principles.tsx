...
const Principles = () => {
  ...
  return (
    <section className="py-16 md:py-24">
      ...
      >
        <h2 id="principles-heading" className="text-2xl md:text-3xl font-bold mb-4">
          Principles That Drive <span className="text-primary">sy</span>NRG<span className="text-primary">y</span>
        </h2>
